...
TextStyle TsBlackMedium =
    GoogleFonts.poppins(fontWeight: FontWeight.w400, color: color2);
TextStyle TsWhiteBold =
    GoogleFonts.poppins(fontWeight: FontWeight.w500, color: color4);
TextStyle TsWhiteMedium =
    GoogleFonts.poppins(fontWeight: FontWeight.w400, color: color4);
